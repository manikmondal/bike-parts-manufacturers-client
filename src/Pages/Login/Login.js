        ...
        <div className='flex h-screen justify-center items-center mt-12'>
            <div className="card w-96 bg-base-100 shadow-xl">
                <div className="card-body">
                    <h2 className="text-center text-3xl font-bold uppercase text-green-500">Login</h2>
                    ...
                    <p>New to Products portal. <Link className='text-primary' to="/signup">Create New Account</Link> </p>
